...
public class time_LBPH_ConfusionMatrix_updates {
	...
	public static void run() throws IOException{
		...
		String trainingDir = "./DATASETS_NOISE_10000/training"+datasetLabel+"_noise/";
		...
		//define a file writer to save time measurement results
		//write to file
		FileWriter writer = new FileWriter("./DATASETS_NOISE_10000/results_LBPH_Updating_10000_"+datasetLabel+".csv ");
	    ...
	    for (File image : trainingImages) {
	          ...
	          counter++;
	          System.out.println("Processing training set stage "+ counter);
	    ...
	    //////////////////////////////////////////////////////////////////////////////////////
	    //recird a time required to test a system with 2 images 
	    ...
	    System.out.println("Train time "+ tempEndTrainTime);
...
//				    	  }
			...
			System.out.println("******************************************************************************");
		    System.out.println("start matching  "+ 2 +" participants to "+newTestingImages.length+ "testing images");
			
			//iterate over test images fir selected instances
...
//						        System.out.println("Prediction Confidence: " + confidence[0]);
			    ...
			    writer.append(',');
			    writer.append(String.valueOf((double)tempEndTrainTime));
			    writer.append(',');
...
//							    	  }
					...
					System.out.println("NUMBER OF TEMPORARY TRAINING IMAGES FOR UPDATE "+tmpImages.size());
					...
					System.out.println("******************************************************************************");
				    System.out.println("start matching  "+ count +" participants to "+currentTestingImages.length+ " testing images");
				    
				    totalTestTime=0;			
					tempStartTotalMatchingTime = System.currentTimeMillis();
	...
	//								    tmpConfusionMatrix.put(new String(actualLabel+","+predictedLabel[0]), matchingScore);
				    ...
				    tempEndTotalMatchingTime=System.currentTimeMillis()-tempStartTotalMatchingTime;
			    	...
			    	System.out.println("AVERAGE UPDATING TIME: "+(double)tempEndUpdateTime);
			    	System.out.println("AVERAGE TEST TIME (RECALL)"+ (double)totalTestTime/currentTestingImages.length);
			    	System.out.println("TOTAL MATCHING TIME "+tempEndTotalMatchingTime);
			    	System.out.println();
				    ...
				    writer.append(',');
				    writer.append(String.valueOf((double)tmpSum/currentTestingImages.length));
				    writer.append(',');
				    writer.append(String.valueOf((double)tempEndUpdateTime));
				    writer.append(',');
				    writer.append(String.valueOf((double)totalTestTime/currentTestingImages.length));
				    writer.append(',');
				    writer.append(String.valueOf((double)tempEndTotalMatchingTime));
				    writer.append('\n');
				    writer.flush();
				    ...
				    /*
				     * Uncomment to see the confusion matrix
				     */
	//						    	System.out.println();
	//							    System.out.println("CONFUSION MATRIX: ");
	//							    System.out.println();
